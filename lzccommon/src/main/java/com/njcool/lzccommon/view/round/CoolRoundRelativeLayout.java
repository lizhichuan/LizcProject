...
public class CoolRoundRelativeLayout extends RelativeLayout {
    private CoolRoundViewDelegate delegate;

    public CoolRoundRelativeLayout(Context context) {
        this(context, null);
    }

    public CoolRoundRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
