package com.njcool.lzccommon.view.vertifycode;
...
public class CoolVerificationCodeEditText extends android.support.v7.widget.AppCompatEditText implements
        CoolVerificationAction, TextWatcher {
    ...
    public CoolVerificationCodeEditText(Context context) {
        this(context, null);
    }

    public CoolVerificationCodeEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CoolVerificationCodeEditText(Context context, AttributeSet attrs, int defStyleAttr) {
