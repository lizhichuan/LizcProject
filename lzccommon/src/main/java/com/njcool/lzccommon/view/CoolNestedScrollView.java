...
public class CoolNestedScrollView extends NestedScrollView {
    ...
    public CoolNestedScrollView(Context context) {
        super(context);
    }

    public CoolNestedScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CoolNestedScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
