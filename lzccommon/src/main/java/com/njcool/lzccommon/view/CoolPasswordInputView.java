...
public class CoolPasswordInputView extends EditText {
    ...
    public CoolPasswordInputView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }

    public CoolPasswordInputView(Context context, AttributeSet attr) {
        super(context, attr);
        init(context, attr);
    }
