package com.njcool.lzccommon.view.swprefresh;
...
public abstract class RefreshDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    private CoolSwipeRefreshLayout mRefreshLayout;

    public RefreshDrawable(Context context, CoolSwipeRefreshLayout layout) {
    ...
    public CoolSwipeRefreshLayout getRefreshLayout(){
