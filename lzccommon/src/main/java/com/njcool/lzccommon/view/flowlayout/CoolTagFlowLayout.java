package com.njcool.lzccommon.view.flowlayout;
 ...
 */
public class CoolTagFlowLayout extends CoolFlowLayout implements TagAdapter.OnDataChangedListener
{
    ...
    public CoolTagFlowLayout(Context context, AttributeSet attrs, int defStyle)
    {
        super(context, attrs, defStyle);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CoolTagFlowLayout);
        mAutoSelectEffect = ta.getBoolean(R.styleable.CoolTagFlowLayout_auto_select_effect, true);
        mSelectedMax = ta.getInt(R.styleable.CoolTagFlowLayout_max_select, -1);
        ta.recycle();
    ...
    public CoolTagFlowLayout(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public CoolTagFlowLayout(Context context)
    {
        this(context, null);
    }
    ...
    {
        boolean onTagClick(View view, int position, CoolFlowLayout parent);
    }
