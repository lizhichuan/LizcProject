 ...
 */
package com.njcool.lzccommon.log.io;

import android.os.Build;

import com.njcool.lzccommon.log.assist.StringUtil;
import com.njcool.lzccommon.log.io.stream.ByteArrayOutputStream;
import com.njcool.lzccommon.log.io.stream.StringBuilderWriter;
...
public class IOUtil {
     ...
     * before using {@link com.vise.utils.io.IOUtil#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see com.vise.utils.io.IOUtil#toByteArray(InputStream, int)
     * @since 2.1
     */
    ...
    public static void write(StringBuffer data, OutputStream output, String encoding) throws IOException {
        if (data != null) {
            output.write(StringUtil.getBytes(data.toString(), Charsets.toCharset(encoding)));
        }
    }
