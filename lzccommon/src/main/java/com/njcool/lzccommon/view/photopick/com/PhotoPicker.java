...
import static com.njcool.lzccommon.view.photopick.com.Constants.EXTRA_STATUSBARCOLOR;
import static com.njcool.lzccommon.view.photopick.com.Constants.EXTRA_TITLE_MARGIN_START;
import static com.njcool.lzccommon.view.photopick.com.Constants.EXTRA_TOOLBARCOLOR;
import static com.njcool.lzccommon.view.photopick.com.Constants.EXTRA_TOOLBAR_WIDGET_COLOR;
...
public class PhotoPicker {
    ...
    public static class PhotoPickerBuilder {
        ...
        public PhotoPickerBuilder setSelected(ArrayList<String> imagesUri) {
            if (imagesUri.size() > 0) {
                if (imagesUri.get(imagesUri.size() - 1).equalsIgnoreCase("add")) {
                    imagesUri.remove(imagesUri.size() - 1);
                }
            }
