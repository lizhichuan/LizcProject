...
public class CoolCustomRoundAngleImageView extends AppCompatImageView {
    float width, height;
    ...
    public CoolCustomRoundAngleImageView(Context context) {
        this(context, null);
        init(context, null);
    }

    public CoolCustomRoundAngleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context, attrs);
    }

    public CoolCustomRoundAngleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param topLeftRadius
     */
    public void setTopLeft(int topLeftRadius) {
        this.leftTopRadius = topLeftRadius;
        invalidate();
    }
     ...
     */
    public void setTopRight(int topRightRadius) {
        this.rightTopRadius = topRightRadius;
        invalidate();
    }
     ...
     */
    public void setBottomLeft(int bottomLeftRadius) {
        this.leftBottomRadius = bottomLeftRadius;
        invalidate();
    }
     ...
     */
    public void setBottomRight(int bottomRightRadius) {
        this.rightBottomRadius = bottomRightRadius;
        invalidate();
    }
     ...
     * @param radius
     */
    public void setAllDiagonal(int radius) {
        this.radius = radius;
