package com.njcool.lzccommon.view.pickview.lib;
...
import com.njcool.lzccommon.view.pickview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mGravity = a.getInt(R.styleable.wheelview_gravity_w, Gravity.CENTER);
